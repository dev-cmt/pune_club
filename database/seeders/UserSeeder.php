...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $Zakiul = User::create([
            ...
            'profile_photo_path'=>'fix/Md. Zakiul Alam Sarker.jpg',
        ]);
        InfoPersonal::create([
            'address'=>'Gulshan',
            'city'=>'Dhaka',
        ...
        $Arifur = User::create([
            ...
            'pune_member' => '1',
            'password'=>bcrypt('password'),
            'profile_photo_path'=>'fix/Khondokar Arifur Rahman.jpg',
        ]);
        InfoPersonal::create([
            'address'=>'Gulshan',
            'city'=>'Dhaka',
        ...
        $Chisty = User::create([
            'name'=>'Reajul Islam Chisty',
            'email'=>'chisty@iconisl.com',
            'batch'=>'1993',
            'contact_number'=>'01756937902',
            'email_verified_at' => '2000-01-01',
            'status' => '1',
            'is_admin' => '1',
            'cm_adviser' => '1',
            ...
            'pune_member' => '1',
            'password'=>bcrypt('password'),
            'profile_photo_path'=>'fix/Sk Md.Reajul Islam.jpg',
        ]);
        InfoPersonal::create([
            'address'=>'Gulshan',
            'city'=>'Dhaka',
