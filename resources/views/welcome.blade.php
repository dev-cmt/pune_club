            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-4 pb-4 ps-4">
                        <img class="img-fluid rounded" src="{{ asset('public/profile/' . $row->profile_photo_path) }}" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
    ...
    <div class="container-fluid py-2 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
                ...
                <div class="">
                    <div class="card team-item" style="width: 18rem;">
                        <div class="team-img position-relative overflow-hidden"  style="height:220px">
                            <img src="{{ asset('public/lose_member/' . $row->image)}}" alt="...">
                        </div>
                        <div class="card-body">
