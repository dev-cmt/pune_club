        ...
        <div class="row gx-0">
            <div class="col-lg-10 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>12/D, Confidence Center, Gulshan</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+88 017 1113 6108</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>info@puneclub.org</small>
                </div>
            </div>
