                        ...
                        <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="email" name="email" placeholder="" value="{{Auth::user()->email}}" class="@error('email') is-invalid @enderror form-control border-0 bg-light px-4" style="height: 40px;">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-lg-6">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="passing_year" placeholder="" value="{{old('passing_year')}}" class="@error('passing_year') is-invalid @enderror form-control border-0 bg-light px-4" style="height: 40px;">
                                    @error('passing_year')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
