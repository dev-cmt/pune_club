    ...
    <div class="container py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="row g-5">
            <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                <img class="img-fluid w-100 rounded mb-5" src="{{asset('public')}}/event/{{ $data->image}}" alt="">
            </div>
                ...
                <form action="{{route('events_register.store', $data->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <label for="cash"><img src="{{asset('public/storage')}}/images/cash.png" alt="Payment Chash" style="transform: scale(1);"/></label>
                        
                            <input type="radio" name="payment_type" id="bKash" class="input-hidden" value="1"/>
                            <label for="bKash"><img src="{{asset('public/storage')}}/images/bKash.png" alt="Payment bKash" /></label>
                        
                            <input type="radio" name="payment_type" id="nagad" class="input-hidden" value="2"/>
                            <label for="nagad"><img src="{{asset('public/storage')}}/images/nagad.png" alt="Payment nagad" /></label>
                        
                            <input type="radio" name="payment_type" id="roket" class="input-hidden" value="3"/>
                            <label for="roket"><img src="{{asset('public/storage')}}/images/roket.png" alt="Payment roket" /></label>
