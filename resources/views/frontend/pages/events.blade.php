                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden" style="height: 200px">
                                    <img class="img-fluid" src="{{asset('public')}}/event/{{ $row->image}}" alt="" width="100%">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="{{asset('public')}}/event/{{ $row->image}}" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0 description_2">{{$row->description}}</a>
                        </div>
                        @endforeach
                    </div>
                    <!-- Recent Post End -->
